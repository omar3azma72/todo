        ...
        builder: (context, state) => AppCubit.get(context).newTasks.length != 0
            ? ListView.separated(
                itemBuilder: (context, index) =>
                    buildTask(AppCubit.get(context).newTasks[index], context),
                    ...
                    child: Column(
                      ...
                      children: [
                        Padding(
                          ...
                          child: Icon(Icons.menu , color: Colors.blueAccent,size: 60,),
                        ),
                        SizedBox(height: 10,),
                        Text("Tasks Are Empty Please Add one",style: TextStyle(fontSize: 30,fontWeight: FontWeight.bold),)
                      ],
                    ),
